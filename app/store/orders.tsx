...
export default function OrdersScreen() {
    ...
    const handleCancel = async (orderId: string) => {
        Alert.alert(
            'Reject Order',
            'Are you sure you want to reject this order? The customer will be refunded.',
            [
                { text: 'No', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            Alert.alert('Done', 'Order rejected and customer has been refunded.');
                        } catch (error: any) {
    ...
    const renderOrderItem = ({ item: order }: { item: any }) => {
        ...
        return (
            <View style={[styles.card, { backgroundColor: cardBg, borderColor }]}>
                ...
                {/* Pickup Info (Customer) */}
                {isPickup && order.customer && (
                    <View style={[styles.riderInfoRow, { borderBottomWidth: 0, paddingBottom: 0 }]}>
                        <View style={styles.riderInfoLeft}>
                            <View style={[styles.riderAvatarSmall, { backgroundColor: '#e0f2fe', justifyContent: 'center', alignItems: 'center' }]}>
                ...
                <View style={styles.footer}>
                    ...
                    <View style={styles.actionButtonsRow}>
                        ...
                        {/* Call Customer Button (For Pickup) */}
                        {isPickup && order.customer?.phone_number && (
                            <TouchableOpacity
