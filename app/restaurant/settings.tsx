...
export default function SettingsScreen() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            let coverUrl = restaurant.restaurant_picture_url;

            // Upload Logo
            if (logoImage) {
                const path = `${restaurant.id}/logo_${Date.now()}.jpg`;
                logoUrl = await uploadImage(logoImage, 'restaurant-documents', path);
            }

            // Upload Cover
            if (coverImage) {
                const path = `${restaurant.id}/cover_${Date.now()}.jpg`;
            ...
            const updates: any = {
                ...
                logo_url: logoUrl,
                restaurant_picture_url: coverUrl,
            };
        ...
        return (
            <ThemedView style={styles.container}>
                ...
                <View style={styles.loadingContainer}>
                    <ThemedText style={styles.errorText}>No restaurant found</ThemedText>
                </View>
            </ThemedView>
        );
    }
        ...
        <ThemedView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.section}>
                    <ThemedText style={styles.sectionTitle}>Restaurant Images</ThemedText>
                    <View style={styles.imagesContainer}>
                        <View style={styles.imageBox}>
                            ...
                            <TouchableOpacity onPress={() => pickImage('logo')}>
                                {logoImage ? (
                                    ...
                                    <Image source={{ uri: restaurant.logo_url }} style={styles.logoImage} />
                                ) : (
                        ...
                        <View style={styles.imageBox}>
                            <ThemedText style={styles.imageLabel}>Restaurant Photo</ThemedText>
                            <TouchableOpacity onPress={() => pickImage('cover')}>
                                {coverImage ? (
                                    ...
                                    <Image source={{ uri: restaurant.restaurant_picture_url }} style={styles.restaurantImage} />
                                ) : (
                                    <View style={styles.placeholderImage}>
                                        <Ionicons name="image-outline" size={40} color="#ccc" />
                                    </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.helperText}>
                        Tap the map or drag the marker to update your restaurant's location.
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TextInput
                            ...
                            placeholder="Detailed description about your restaurant"
                            placeholderTextColor="#999"
                            multiline
                            numberOfLines={5}
                        />
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <ThemedText style={styles.infoValue}>
                            {restaurant.business_registration_number || 'Not provided'}
                        </ThemedText>
                    </View>

                    <View style={styles.infoRow}>
                        <ThemedText style={styles.infoLabel}>Restaurant ID:</ThemedText>
                        <ThemedText style={styles.infoValue}>{restaurant.id}</ThemedText>
                    </View>
