...
export default function SelectRiderScreen() {
    ...
    const fetchData = async () => {
        ...
        // Separate pending bids from invites
    ...
    const renderRiderCard = ({ item, type }: { item: Rider | RiderBid, type: 'bid' | 'invite' | 'available' }) => {
        ...
        if (type === 'bid') {
            ...
            buttonColor = ['#9ca3af', '#6b7280']; // Grey
            buttonIcon = "time";
            isDisabled = true;
        } else {
            ...
            >
                ...
                <View style={styles.headerContent}>
                    ...
                    <ThemedText style={styles.headerSubtitle}>
                        {bids.length} interested • {invites.length} invited • {availableRiders.length} nearby
                    </ThemedText>
                </View>
                <TouchableOpacity
